...
<div class="page" id="top">
    ...
    <header>
        ...
        <div class="header-center">
            ...
            <div class="header-title">تقرير زيارة ذكي</div>
            <div class="header-subtitle">(توجيه مواد - محلي)</div>
        </div>
        <div class="header-left">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/Emblem_of_Yemen.svg/200px-Emblem_of_Yemen.svg.png" alt="شعار">
        </div>
    </header>
    ...
    <table>
        <thead><tr><th colspan="5" style="background:#ddd;">الإدارة المدرسية (العدد)</th></tr><tr><th>مدير</th><th>وكيل</th><th>إداريون</th><th>عمل</th><th>أخرى</th></tr></thead>
    ...
    <div style="display: flex; gap: 5px;">
        <div style="flex: 1;">
            <table>
                ...
                <thead>
                    <tr><th colspan="6" style="background:#e8e8e8;">بيانات المعلم</th></tr>
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td><select><option></option><option>نظيفة</option><option>متوسطة</option><option>غير نظيفة</option></select></td>
                <td><select><option></option><option>نظيفة</option><option>متوسطة</option><option>غير نظيفة</option></select></td>
                <td><select><option></option><option>نظيفة</option><option>متوسطة</option><option>ضعيفة</option></select></td>
